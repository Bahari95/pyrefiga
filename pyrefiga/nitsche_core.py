            ...
            for ie2 in range(0, ne2):
                ...
                for il_2 in range(0, p2+1):
                    for jl_2 in range(0, p2+1):
                        ...
                        matrix[p1, p2+i2, p1+1, p2+j2-i2]    += vjp
        if interface_nb == 2:
            bx_right   = p3/(knots_3[-1]-knots_3[-p3-2])*(omega_1[-2]/omega_1[-1])
            bx_rightFE = p1/(knots_1[-1]-knots_1[-p1-2])
            #... Assemble the boundary condition for Nitsche (x=right)
            ie1      = ne1 -1
            i_span_1 = spans_1[ie1]
            for ie2 in range(0, ne2):         
            ...
            for ie1 in range(0, ne1):
                ...
                for il_1 in range(0, p1+1):
                    for jl_1 in range(0, p1+1):
                        ...
                        matrix[p1+i1, p2, p1+j1-i1, p2+1]   += vjp
        if interface_nb == 4:
            by_right   = p4/(knots_4[-1]-knots_4[-p2-2])*(omega_2[-2]/omega_2[-1])
            by_rightFE = p2/(knots_2[-1]-knots_2[-p2-2])
            #... Assemble the boundary condition for Nitsche (y=right)
            ie2      = ne2 -1
            i_span_2 = spans_2[ie2]
            for ie1 in range(0, ne1):
...
def assemble_matrix_DiffSpaceoffdiagnitsche(
    ...
    if interface_nb == 1 :
        ...
        by_left    = p4/(knots_4[p4+1]-knots_4[0])*omega_2[1]/omega_2[0]
        by_right   = p4/(knots_4[-1]-knots_4[-p4-2])*omega_2[-2]/omega_2[-1]
        # ...
        by_leftFE  = p2/(knots_2[p2+1]-knots_2[0])
        by_rightFE = p2/(knots_2[-1]-knots_2[-p2-2])
        # ...
