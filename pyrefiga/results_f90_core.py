...
def ders_bspline_grid(ne1:'int', p1:'int', spans_1:'int[:]', basis_1:'float64[:,:,:]', points_1:'float64[:]', knots_1:'float64[:]', nders:'int'):
    ...
    # Notes
    # -----
    # This function computes the non-zero basis functions and their derivatives at each interpolation point
    ...
    for ie1 in range(0, ne1):
        ...
        for i_ders in range(1,nders+1):
            ...
            r = r * (degree-i_ders)
#-----------------------------------------------           
#  cubic Hermet matrix A: induced from the system 
# A * eta = rhs for cubic spline interpolation with derivative boundary conditions.
#----------------------------------------- 
def cubic_Hermit_matrix_grid(ne1:'int', points_1:'float64[:]', knots_1:'float64[:]', matrix:'float64[:,:]'):
    ...
    # Notes
    # -----
    # This function computes the non-zero basis functions at each point
    # for all elements in a 1D mesh, and bundary direvatives (Hermit).
    # ... sizes
    from numpy import zeros
    from numpy import empty
    #   ---Computes All basis in a new points
