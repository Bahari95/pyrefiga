...
from gallery.gallery_section_00         import assemble_norm_un_ex02

assemble_matrix_un   = compile_kernel(assemble_matrix_mass_ex01, arity=2)
...
parser.add_argument("--h", type=int, default=0, help="Number of elements to elevalte the grid (default: 2)")
