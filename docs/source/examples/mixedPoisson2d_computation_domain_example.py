"""
mixedPoisson2d_computation_domain_example.py : unit-square

Example on how one can solve 2D mixed Poisson equation
using B-spline basis functions in a uniform mesh.
